...
import com.kii.blacbot.Ochat.ui.ChatActivity;
								...
								try {
									...
									if (isMember(kiiGroup)) {
										if (isForeground(context)) {
											//Toast.makeText(context, "ISForgeround true", Toast.LENGTH_LONG).show();
											sendBroadcast(context, ApplicationConst.ACTION_MESSAGE_RECEIVED, chatMessage.getKiiObject().toJSON().toString());
										} else if (!sender.equals(KiiUser.getCurrentUser()) || true) {
											//Toast.makeText(context, "ISForgeround false", Toast.LENGTH_LONG).show();
