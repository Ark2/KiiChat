...
/**
 */
@SuppressLint("ValidFragment") public class ConfirmAddFriendDialogFragment extends DialogFragment {
	...
	@SuppressLint("ValidFragment") public static ConfirmAddFriendDialogFragment newInstance(OnAddFriendListener onAddFriendListener, JSONObject user, int position) {
